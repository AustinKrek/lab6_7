...
void init_button_interrupts() {
    ...
    NVIC_EN0_R |= 0b11111111;   //FIXME MAYBE
...
uint8_t button_getButton() {
    ...
    if ((GPIO_PORTE_DATA_R | 0b11111110) == 0b11111110)  // if S1 is pushed
    {
        ret = 0b11111110;
    }

    if ((GPIO_PORTE_DATA_R | 0b11111101) == 0b11111101)  // if S2 is not pushed
    {
        ret = 0b11111101;
    }

    if ((GPIO_PORTE_DATA_R | 0b11111011) == 0b11111011)  // if S3 is pushed
    {
        ret = 0b11111011;
    }

    if ((GPIO_PORTE_DATA_R | 0b11110111) == 0b11110111)  // if S4 is not pushed
    {
        ret = 0b11110111;
    }
